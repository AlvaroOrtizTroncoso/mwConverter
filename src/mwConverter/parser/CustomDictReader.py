'''
http://code.activestate.com/recipes/577996-ordered-csv-read-write-with-colum-based-lookup/?in=user-4177968
...
class CustomDictReader(csv.DictReader):
    ...
    def __init__(self, f, delim, fieldnames = None, restkey = None, restval = None, dialect ="excel", *args, **kwds):
        csv.DictReader.__init__(self, f, delimiter=delim, fieldnames = None, restkey = None, restval = None, dialect = "excel", *args, **kwds)
